...
class ColorsTableViewController: UIViewController {
    ...
    enum Cells { static let colorCell = "ColorCell" }
    
    enum Segues { static let toDetail = "ToColorsDetail" }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let destinationViewControler = segue.destination as! ColorsDetailViewController
        destinationViewControler.color = sender as? UIColor
    }
}
